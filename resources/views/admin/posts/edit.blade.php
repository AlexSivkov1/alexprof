                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Публикация "{{ $post->title }}" </h3>
                        </div>
                        <!-- /.card-header -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description"
                                              ...
                                              id="description" rows="5"> {{ $post->description }}</textarea>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="thumbnail">Выбрать файл изображения</label>
                                        </div>
                                    </div>
                                    <div> <img src="{{ $post->getImage() }}" alt="" class="img-thumbnail mt-2" width="550"></div>
